...
Quintus.TMX = function(Q) {
 ...
 Q._tmxProcessObjectLayer = function(stage,gidMap,tileProperties,layer) {
   ...
   for(var i=0;i < objects.length;i++) {
     ...
     if(!properties) { throw "Invalid TMX Object: missing properties"; }
     if(!properties['Class']) { throw "Invalid TMX Object: missing Class"; }

     var className = properties['Class'];
     if(!className) { throw "Invalid TMX Object Class: " + className; }

     var p = Q._extend(Q._extend({ x: x, y: y }, properties), {});
